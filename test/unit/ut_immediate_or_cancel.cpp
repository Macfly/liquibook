...
#define BOOST_TEST_MODULE liquibook_ImmediateOrCancel
...
BOOST_AUTO_TEST_CASE(TestIocBidNoMatch)
{
  ...
  BOOST_REQUIRE(dc.verify_bid(1248, 1, 100));
  ...
  { BOOST_REQUIRE_NO_THROW(
    ...
    BOOST_REQUIRE(add_and_verify(order_book, &bid0, false, false, IOC));
  ); }
...
BOOST_AUTO_TEST_CASE(TestIocBidPartialMatch)
{
  ...
  BOOST_REQUIRE(dc.verify_bid(1249, 1, 100));
  BOOST_REQUIRE(dc.verify_bid(1248, 1, 100));
  BOOST_REQUIRE(dc.verify_ask(1250, 1, 100));
  BOOST_REQUIRE(dc.verify_ask(1251, 1, 100));
  BOOST_REQUIRE(dc.verify_ask(1252, 1, 100));
  ...
  { BOOST_REQUIRE_NO_THROW(
    ...
    SimpleFillCheck fc4(&ask1, 0, 0);
    SimpleFillCheck fc5(&ask2, 0, 0);
    BOOST_REQUIRE(add_and_verify(order_book, &bid0, true, false, IOC));
  ); }
...
BOOST_AUTO_TEST_CASE(TestIocBidFullMatch)
{
  ...
  BOOST_REQUIRE(dc.verify_bid(1249, 1, 100));
  BOOST_REQUIRE(dc.verify_bid(1248, 1, 100));
  BOOST_REQUIRE(dc.verify_ask(1250, 1, 400));
  BOOST_REQUIRE(dc.verify_ask(1251, 1, 100));
  BOOST_REQUIRE(dc.verify_ask(1252, 1, 100));
  ...
  { BOOST_REQUIRE_NO_THROW(
    ...
    SimpleFillCheck fc4(&ask1, 0, 0);
    SimpleFillCheck fc5(&ask2, 0, 0);
    BOOST_REQUIRE(add_and_verify(order_book, &bid0, true, true, IOC));
  ); }
...
BOOST_AUTO_TEST_CASE(TestFokBidNoMatch)
{
  ...
  { BOOST_REQUIRE_NO_THROW(
    ...
    SimpleFillCheck fc4(&ask1, 0, 0);
    SimpleFillCheck fc5(&ask2, 0, 0);
    BOOST_REQUIRE(add_and_verify(order_book, &bid0, false, false, FOK));
  ); }
...
BOOST_AUTO_TEST_CASE(TestFokBidFullMatch)
{
  ...
  { BOOST_REQUIRE_NO_THROW(
    ...
    SimpleFillCheck fc4(&ask1, 0, 0);
    SimpleFillCheck fc5(&ask2, 0, 0);
    BOOST_REQUIRE(add_and_verify(order_book, &bid0, true, true, FOK));
  ); }
...
BOOST_AUTO_TEST_CASE(TestIocAskNoMatch)
{
  ...
  { BOOST_REQUIRE_NO_THROW(
    ...
    SimpleFillCheck fc4(&ask1, 0, 0);
    SimpleFillCheck fc5(&ask2, 0, 0);
    BOOST_REQUIRE(add_and_verify(order_book, &ask0, false, false, IOC));
  ); }
...
BOOST_AUTO_TEST_CASE(TestIocAskPartialMatch)
{
  ...
  { BOOST_REQUIRE_NO_THROW(
    ...
    SimpleFillCheck fc4(&ask1, 0, 0);
    SimpleFillCheck fc5(&ask2, 0, 0);
    BOOST_REQUIRE(add_and_verify(order_book, &ask0, true, false, IOC));
  ); }
...
BOOST_AUTO_TEST_CASE(TestIocAskFullMatch)
{
  ...
  { BOOST_REQUIRE_NO_THROW(
    ...
    SimpleFillCheck fc4(&ask1, 0, 0);
    SimpleFillCheck fc5(&ask2, 0, 0);
    BOOST_REQUIRE(add_and_verify(order_book, &ask0, true, true, IOC));
  ); }
...
BOOST_AUTO_TEST_CASE(TestFokAskNoMatch)
{
  ...
  { BOOST_REQUIRE_NO_THROW(
    ...
    SimpleFillCheck fc4(&ask1, 0, 0);
    SimpleFillCheck fc5(&ask2, 0, 0);
    BOOST_REQUIRE(add_and_verify(order_book, &ask0, false, false, FOK));
  ); }
...
BOOST_AUTO_TEST_CASE(TestFokAskFullMatch)
{
  ...
  { BOOST_REQUIRE_NO_THROW(
    ...
    SimpleFillCheck fc4(&ask1, 0, 0);
    SimpleFillCheck fc5(&ask2, 0, 0);
    BOOST_REQUIRE(add_and_verify(order_book, &ask0, true, true, FOK));
  ); }
